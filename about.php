...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
      ...
      <div class="container">
      <div class="row">
      <div class="col col-12 col-sm-4 col-md- col-lg-4">

          <img width="400" height="400" src="images\a2.jpg">
          <br>
          <br>
          <br>
          <img width="400" height="400"src="images\r3.jpg">
      ...
      <p>
        ...
        tsunamis, fires, avalanches, etc. </p>
        <p>
        They assist firemen and policemen in tracking people and they rescue thousands of people across the
      ...
      <div class="col col-12 col-sm-4 col-md- col-lg-4">
        <img width="400" height="400" src="images\p1.jpg">
        <br>
        <br>
        <br>
        <img width="400" height="400" src="images/r1.jpg">
    </div>
      </div>
      </div>
    </div>
